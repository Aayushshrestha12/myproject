        ...
        <main class="main-content" id="mainContent">
            ...
            <div class="top-bar">
                ...
                <div class="profile-dropdown" id="profileDropdown">
                    <h3>Admin Profile</h3>
                    <form method="post" action="update_admin_profile_action.php">
            ...
            while ($user = $result->fetch_assoc()) {
                echo "<tr id='user-{$user['user_id']}'>
                    <td>{$user['user_id']}</td>
                    <td><input type='text' value='{$user['first_name']}' id='fname-{$user['user_id']}'></td>
                    <td><input type='text' value='{$user['last_name']}' id='lname-{$user['user_id']}'></td>
                    <td><input type='email' value='{$user['email']}' id='email-{$user['user_id']}'></td>
                    <td><input type='text' value='{$user['phone']}' id='phone-{$user['user_id']}'></td>
                    <td><input type='text' value='{$user['address']}' id='address-{$user['user_id']}'></td>
                    <td>
                        <button onclick='updateUser({$user['user_id']})'>Save</button>
                        <button onclick='deleteUser({$user['user_id']})' style='color:red;'>Delete</button>
                    </td>
                </tr>";
            }
            ?>
...
<div class="content-section" id="manage-provider">
    ...
    <table border="1" cellpadding="10" id="vendorTable">
        <thead>
            <tr>
                <th>ID</th>
                <th>Name</th>
...
<tr id="vendor-<?= $vendor['vendor_id'] ?>">
    ...
    <td>
        <button class="action-btn" data-id="<?= $vendor['vendor_id'] ?>" data-action="approve" style="color:green;">Approve</button>
        <button class="action-btn" data-id="<?= $vendor['vendor_id'] ?>" data-action="reject" style="color:red;">Reject</button>
    </td>
</tr>
<?php endwhile; ?>
</tbody>
